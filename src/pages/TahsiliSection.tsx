...
export default function TahsiliSection() {
  ...
  const toggleSubject = (sourceId: string, sourceName: string, subject: TahsiliSubject) => toggleSource(makeId(sourceId, subject), `${sourceName} - ${TAHSILI_SUBJECTS[subject]}`, testType, sourceId);
  ...
  const activeSource = testTypeSources[0]?.groupId;
