    ...
    <div className="space-y-4">
      ...
      <div className="card animate-fade-up p-5 sm:p-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div><label className="mb-1.5 flex items-center gap-1.5 text-xs font-bold text-ink-200"><Clock className="h-3.5 w-3.5 text-sky-400" />تاريخ البداية</label><input type="date" value={scheduleConfig.startDate} onChange={(e) => setScheduleConfig({ startDate: e.target.value })} className="input-field" /></div>
          <div><label className="mb-1.5 flex items-center gap-1.5 text-xs font-bold text-ink-200"><Clock className="h-3.5 w-3.5 text-gold-300" />تاريخ النهاية</label><input type="date" value={scheduleConfig.endDate} min={scheduleConfig.startDate} onChange={(e) => setScheduleConfig({ endDate: e.target.value })} className="input-field" /></div>
        </div>
        <div className="mt-4">
